import{p as n,O as t}from"./index-tgiEQhDf.js";n.forBlock.ninja_servo_set=function(e){const o=e.getFieldValue("SERVO_NUM"),r=e.getFieldValue("ANGLE");return`robot.servo[${o-1}].set_angle(${r})
